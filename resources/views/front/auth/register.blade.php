...
<table width="350"><tbody><tr><td colspan="2" align="center">Interested in:<br><input type="radio" name="interst" value="Fitness" onclick="javascript:show('divfitness');"> Fitness <input type="radio" name="interst" value="Wellness" onclick="javascript:show('divwellness');"> Wellness <input type="radio" name="interst" value="Sports Performance" onclick="javascript:show('divsportsperformance');"> Sports Performance</td></tr></tbody></table><br>
