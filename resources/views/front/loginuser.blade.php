...
@csrf
@method('POST')
<input type="hidden" name="redirect" value=""><center><div style="width:300px;height:500px;position:relative;">
<div style="position:absolute;left:0px;top:0px;opacity:.9;width:300px;height:100px;z-index:0">
<div style="position:absolute;background-color:#fefefe;width:300px;height:100px;">
</div>
</div>
<div style="position:absolute;left:0px;top:0px;opacity:.5;width:300px;height:500px;z-index:0">
<div style="position:absolute;background-color:#fefefe;width:300px;height:500px;">
</div>
</div>
<div style="position:absolute;left:0px;top:15px;opacity:1;width:300px;height:500px;z-index:1">
<center><img src="{{ asset('assets/front/images/loginslide/logoresized.png') }}" width="90" height="64"></center>
</div>
<div style="vertical-align:top;position:absolute;left:0px;top:150px;opacity:1;width:300px;height:400px;z-index:1;">
<table width="300">
<tbody><tr><td align="center">
Please enter your username and password to login:<br><br><table>
<tbody><tr><td align="right">
<input id="username" name="username" value="Username" style="vertical-align:center;text-indent:40px;color:#999;font-size:24px;width:250px;height:40px;background-image:url('assets/front/images/loginslide/personbackground.png')" onclick="javascript:document.getElementById('username').value='';"></td></tr>
<tr><td align="right">
<input id="password" name="password" value="Password" style="vertical-align:center;text-indent:40px;color:#999;font-size:24px;width:250px;height:40px;background-image:url('assets/front/images/loginslide/lockbackground.png')" onclick="javascript:document.getElementById('password').value='';"></td></tr>
<tr><td colspan="2" align="center"><br><input type="Submit" value="Submit"><br><br>
<a href="{{ URL::route('forgotpassword') }}">Forgot password?</a><br><br>
New user? <a href="{{ URL::route('userregister') }}">Create a profile</a> now!<br><br></td></tr></tbody></table></td></tr>
</tbody></table>
</div>
</div>
</center>
