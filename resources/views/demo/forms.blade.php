...
<table cellspacing="0" cellpadding="5" border="1"><tbody><tr><td>
	<a href="{{ URL::to('abbrivation') }}">Arbitration Agreement and Informed Consent</a></td><td><input type="checkbox" name="forms[]" value="Arbitration Agreement and Informed"></td></tr><tr><td><a href="{{ URL::to('assignment') }}">Agreement of Insurance Payment Paid to Patient</a></td><td><input type="checkbox" name="forms[]" value="Agreement of Insurance Payment Paid to Patient.php"></td></tr><tr><td><a href="{{ URL::to('cancellation') }}">Cancellation Policy No Show Policy</a></td><td><input type="checkbox" name="forms[]" value="Cancellation Policy No Show Policy.php"></td></tr><tr><td>
		<a href="{{ URL::to('hippa') }}">HIPAA Form</a></td><td><input type="checkbox" name="forms[]" value="HIPAA Form.php"></td></tr><tr><td>
			<a href="{{ URL::to('media') }}">Media Release</a></td><td><input type="checkbox" name="forms[]" value="Media Release.php"></td></tr><tr><td>
				<a href="{{ URL::to('accident') }}">Auto Accident Form</a></td><td><input type="checkbox" name="autoaccidentform" value="true"></td></tr><tr><td><a href="{{ URL::to('backindex') }}">Back Index</a></td><td><input type="checkbox" name="backindexform" value="true"></td></tr><tr><td><a href="{{ URL::to('neckindex') }}">Neck Index</a></td><td><input type="checkbox" name="neckindexform" value="true"></td></tr><tr><td><a href="{{ URL::to('autoaccident') }}">Auto Accident Description</a></td><td><input type="checkbox" name="autoaccidentdescription" value="true"></td></tr></tbody></table><br>
<input type="image" src="{{ asset('/nlimages/submitbutton.png') }}">    </form></td></tr></tbody></table></td></tr></tbody></table>
</form></body></html>
