...
<tr id="portalcalendar.phptr" onmouseover="changebg('portalcalendar.php','on');" onmouseout="changebg('portalcalendar.php','off')" height="50"><td width="75" valign="middle" align="right">
	...
	<img src="{{ asset('nlimages/portal/checkout.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;
		<a href="{{ route('portalcheckout') }}" style="color:black;text-decoration:none;">Checkout</a></td></tr><tr id="portalreports.phptr" onmouseover="changebg('portalreports.php','on');" onmouseout="changebg('portalreports.php','off')" style="" height="50"><td width="75" valign="middle" align="right">
...
<tbody><tr><td colspan="2">&nbsp;</td></tr>
<tr id="portalcalendar.phptr" onmouseover="changebg('portalcalendar.php','on');" onmouseout="changebg('portalcalendar.php','off')" height="50"><td width="75" valign="middle" align="right">
	<img src="{{ asset('nlimages/portal/calendar.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;<a href="{{ route('portalcalendar') }}" style="color:black;text-decoration:none;">Calendar</a></td></tr><tr id="portaldashboard.phptr" onmouseover="changebg('portaldashboard.php','on');" onmouseout="changebg('portaldashboard.php','off')" style="" height="50"><td width="75" valign="middle" align="right">
	<img src="{{ asset('nlimages/portal/dashboard.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;
		<a href="{{ route('portaldashboard') }}" style="color:black;text-decoration:none;">Dashboard</a></td></tr><tr id="portalcustomers.phptr" onmouseover="changebg('portalcustomers.php','on');" onmouseout="changebg('portalcustomers.php','off')" style="" height="50"><td width="75" valign="middle" align="right">
	<img src="{{ asset('nlimages/portal/customers.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;<a href="portalcustomers.php" style="color:black;text-decoration:none;">Customers</a></td></tr><tr id="portalcheckout.phptr" onmouseover="changebg('portalcheckout.php','on');" onmouseout="changebg('portalcheckout.php','off')" style="" height="50"><td width="75" valign="middle" align="right">
	<img src="{{ asset('nlimages/portal/checkout.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;<a href="portalcheckout.php" style="color:black;text-decoration:none;">Checkout</a></td></tr><tr id="portalreports.phptr" onmouseover="changebg('portalreports.php','on');" onmouseout="changebg('portalreports.php','off')" style="" height="50"><td width="75" valign="middle" align="right">
	<img src="{{ asset('nlimages/portal/reports.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;<a href="portalreports.php" style="color:black;text-decoration:none;">Reports</a></td></tr><tr id="portalforms.phptr" onmouseover="changebg('portalforms.php','on');" onmouseout="changebg('portalforms.php','off')" style="" height="50"><td width="75" valign="middle" align="right">
	<img src="{{ asset('nlimages/portal/forms.png') }}" style="display:inline;" height="30"> </td><td style="font-size:18px;">&nbsp;&nbsp;<a href="portalforms.php" style="color:black;text-decoration:none;">Forms</a></td></tr>
</tbody></table>
</div>
</td>
<td id="viewport" width="100%" valign="top" align="left">
