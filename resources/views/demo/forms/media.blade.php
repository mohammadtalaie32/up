...
<div align="justify"><h2>MEDIA RELEASE</h2><br><br>
<input type="checkbox"> 1) I, the undersigned, hereby authorize Up 2 Speed Sports Performance and Therapy to photograph me, take motion pictures of me, take video footage of me, and/or make electronic sound recordings of me (herein referred to as photographic or electronic reproductions). <br><br>

<input type="checkbox"> 2) I authorize the use of any such photographic or electronic reproductions of me for any purpose, including, but not limited to educational and other public media as may be deemed appropriate by Up 2 Speed Sports Performance and Therapy (I understand that I may be identifiable from such photographic or electronic reproduction).<br><br>
I consent to above statements <br><br></div><script src="https://cdn.jsdelivr.net/npm/signature_pad@2.3.2/dist/signature_pad.min.js"></script>    <br>Signed: <canvas style="border: 1px solid black; touch-action: none;" width="300" height="70"></canvas><br><br>
Date: <input><br><br>
