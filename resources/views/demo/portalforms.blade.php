...
<table width="100%" cellpadding="10 "><tbody><tr><td width="100%" valign="top">
   <script>
function changeform(){
	window.location.href='portalforms.php?form='+document.getElementById('forms').value;
}
</script>
<select name="forms" id="forms" onchange="changeform()"><option value="">Fill New Form</option><option value="Arbitration Agreement and Informed Consent.php">Arbitration Agreement and Informed Consent</option><option value="Agreement of Insurance Payment Paid to Patient.php">Agreement of Insurance Payment Paid to Patient</option><option value="Cancellation Policy No Show Policy.php">Cancellation Policy No Show Policy</option><option value="HIPAA Form.php">HIPAA Form</option><option value="Media Release.php">Media Release</option></select>    </td></tr></tbody></table></td></tr></tbody></table>
</form></body></html>
