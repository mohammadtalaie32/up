...
<body>
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:0px;" valign="top" align="center">
                                                        ...
                                                        <a style="color:black;text-decoration:none;" href="">NEW VISIT</a>
                                ...
                                <tr height="35">
                                    <td class="side-link "
                                        ...
                                        @if(Request::route()->getName() == 'familyhistory') <b> @endif
                                ...
                                <tr height="35">
                                    <td class="side-link "
                                        align="center">
                                        @if(Request::route()->getName() == 'socialhistory') <b> @endif
                                ...
                                <tr height="35">
                                    <td class="side-link
                                        ...
                                        @if(Request::route()->getName() == 'preexistingconditions') <b> @endif
                                            <a href="{{ route('preexistingconditions', $data->id) }}"
                                                style="color:black;text-decoration:none;">
                                ...
                                <tr height="35">
                                    <td class="side-link {{ Route::current()->getName() == 'insuranceinfo' ? 'active' : '' }}"
                                        ...
                                        @if(Request::route()->getName() == 'insuranceinfo') <b> @endif
                                            <a href="{{ route('insuranceinfo', $data->id) }}"
                                                style="color:black;text-decoration:none;">
                                ...
                                <tr height="35">
                                    <td class="side-link {{ Route::current()->getName() == 'billing' ? 'active' : '' }}"
                                        ...
                                        @if(Request::route()->getName() == 'billing') <b> @endif
        ...
        <tr height="35">
            <td class="tdbg1" background ="{{ asset('nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center">
              <a href="{{ Route('subjective' , $data->id) }}" style="color:white;text-decoration:none;">
                <div style="width:100%;height:100%">Subjective</div>
              </a>
            </td>
        </tr>
		...
		<tr height="35">
            <td class="tdbg1" background ="{{ asset('nlimages/navbgactive.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center">
              <a href="{{ Route('subjective', $data->id) }}" style="color:white;text-decoration:none;">
                  <div style="width:100%;height:100%">Objective</div>
              </a>
            </td>
        </tr>
        ...
        <tr height="35">
            <td td class="tdbg1" background ="{{ asset('nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;"  align="center">
                <a href="{{ URL::to('/subjective/'.$data->id) }}" style="color:white;text-decoration:none;">
                    <div style="width:100%;height:100%">Assessment</div>
                </a>
            </td>
        </tr>

        <tr height="35"><td class="tdbg1" background ="{{ asset('nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center">
