...
<img src="{{ asset('nlimages/areas/anteriorleg.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/anteriorknee.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/bottomfoot.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/lateralanklefoot.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/lateralknee.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/medialanklefoot.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/medialknee.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/posteriorankle.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/posteriorknee.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/posteriorleg.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/superiorknee.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/superiorknee2.jpeg') }}" width="500">
<img src="{{ asset('nlimages/areas/topoffoot.jpeg') }}" width="500">    </td></tr></tbody></table></td></tr></tbody></table>
</form></body></html>
