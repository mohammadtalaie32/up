...
<table cellspacing="0" cellpadding="5" border="1">
	...
	<a href="{{ asset('assets/front/exams/Ankle_Leg.pdf') }}">Ankle_Leg.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Cervicothoracic_Exam (1).pdf') }}">Cervicothoracic_Exam (1).pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Cervicothoracic_Exam.pdf') }}">Cervicothoracic_Exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr>
	<tr><td>
	<a href="{{ asset('assets/front/exams/Clinic-Exit-Exam-Vizniak.pdf') }}">Clinic-Exit-Exam-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Consent_to_treat_form.pdf') }}">Consent_to_treat_form.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Elbow_exam.pdf') }}">Elbow_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Extremity-Practical-Vizniak.pdf') }}">Extremity-Practical-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Eye_ear_nose_Exam.pdf') }}">Eye_ear_nose_Exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Gait-Exam-Practical-Vizniak-1.pdf') }}">Gait-Exam-Practical-Vizniak-1.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/General_physical_exam_1.pdf') }}">General_physical_exam_1.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/General_physical_exam_2.pdf') }}">General_physical_exam_2.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Heart_lung_abdomen_exam.pdf') }}">Heart_lung_abdomen_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center">
	<a href="javascript:send('')">Send</a></td></tr><tr><td><a href="{{ asset('assets/front/exams/Hip_exam.pdf') }}">Hip_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td><a href="{{ asset('assets/front/exams/Initial_scan_exam.pdf') }}">Initial_scan_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Joint-Mobilization-Exam-Vizniak.pdf') }}">Joint-Mobilization-Exam-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Knee_thigh_exam.pdf') }}">Knee_thigh_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Lower_body_exam.pdf') }}">Lower_body_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Lumbopelvic_exam.pdf') }}">Lumbopelvic_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Massage-Practical-Final-Exam-Vizniak.pdf') }}">Massage-Practical-Final-Exam-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Massage-Skills-Final-Exam.pdf') }}">Massage-Skills-Final-Exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td><a href="{{ asset('assets/front/exams/Massage-Skills-Midterm-Exam.pdf') }}">Massage-Skills-Midterm-Exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-Ankle-Foot.pdf') }}">MM-SS-Ankle-Foot.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-Bruggers-seated-stretch.pdf') }}">MM-SS-Bruggers-seated-stretch.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-Elbow.pdf') }}">MM-SS-Elbow.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-Knee.pdf') }}">MM-SS-Knee.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td><a href="{{ asset('assets/front/exams/MM-SS-Neck-Head.pdf') }}">MM-SS-Neck-Head.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-Pelvis-Hip.pdf') }}">MM-SS-Pelvis-Hip.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-shoulder.pdf') }}">MM-SS-shoulder.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/MM-SS-Wrist-Hand.pdf') }}">MM-SS-Wrist-Hand.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Muscle-Exam-Practical-Vizniak.pdf') }}">Muscle-Exam-Practical-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Neurologic_exam.pdf') }}">Neurologic_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Pain-Scale-ProHealth-Vizniak.pdf') }}">Pain-Scale-ProHealth-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Peripheral_joint_exam.pdf') }}">Peripheral_joint_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/PHS-Presentation-review.pdf') }}">PHS-Presentation-review.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td><a href="{{ asset('assets/front/exams/Posture-Exam-Practical-Vizniak.pdf') }}">Posture-Exam-Practical-Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Shoulder_exam.pdf') }}">Shoulder_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Skill-check-assessment.pdf') }}">Skill-check-assessment.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td><a href="{{ asset('assets/front/exams/Spinal-Practical-Dr.Vizniak.pdf') }}">Spinal-Practical-Dr.Vizniak.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Spinal_joint_exam.pdf') }}">Spinal_joint_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Stabilization-Bridge-Track-Lumbar-SI.pdf') }}">Stabilization-Bridge-Track-Lumbar-SI.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Stabilization-Dead-Bug-Track-Lumbar-SI.pdf') }}">Stabilization-Dead-Bug-Track-Lumbar-SI.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Stabilization-Neutral-Pelvis-Lumbar-SI.pdf') }}">Stabilization-Neutral-Pelvis-Lumbar-SI.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Stabilization-Prone-Ball-Track-Lumbar-SI.pdf') }}">Stabilization-Prone-Ball-Track-Lumbar-SI.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Stabilization-Quadriped-Track-Lumbar-SI.pdf') }}">Stabilization-Quadriped-Track-Lumbar-SI.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Upper_body_exam.pdf') }}">Upper_body_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr><tr><td>
	<a href="{{ asset('assets/front/exams/Wrist_hand_exam.pdf') }}">Wrist_hand_exam.pdf</a></td><td><input type="radio" name="modify" value="doctor">Doctor <input type="radio" name="modify" value="patient">Patient</td><td align="center"><a href="javascript:send('')">Send</a></td></tr></tbody></table><br>
