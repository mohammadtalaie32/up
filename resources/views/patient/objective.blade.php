...
<table><tbody><tr><td></td><td width="10"></td><td style="color:white;"><font size="+1"><strong>Patient selected:</strong> {{$data->lastname }},{{$data->firstname }}&nbsp;&nbsp;
    ...
    <div style="display:inline;position:relative;"> <strong>Visit: </strong> <select name="pick" onchange="javascript:pickencounter();">
      ...
      <img src="{{ asset('nlimages/radioactive.png') }}" height="14"> {{$visit->datemonth}}/{{$visit->dateday}}/{{$visit->dateyear}} <a href="javascript:pickanencounter('03/27/2020','editvisits.php')">
      ...
      <tr height="35"><td background ="{{ asset('nlimages/navbgpatient.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Billing</div></a></td></tr><tr><td "="" align="center">
            ...
            <img src="{{ asset('nlimages/visitinformation.png') }}"></td></tr><tr height="35">
                  <td background ="{{ asset('nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="" style="color:white;text-decoration:none;">
                        ...
                        <div style="width:100%;height:100%">Subjective</div></a></td></tr><tr height="35"><td background ="{{ asset('nlimages/navbgactive.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">
                        ...
                        Objective</div></a></td></tr><tr height="35"><td background ="{{ asset('nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="" style="color:white;text-decoration:none;">
                              ...
                              <tr height="35">
                              <td background="{{ asset('nlimages/navbgexercises.png') }}"style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="{{URL::to('/excercise/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Exercises</div></a></td></tr><tr height="35">
...
<script src="{{ asset('assets/front/mapper.js') }}"></script>
<script>
function show(id){
...
<IMG src="{{ asset('assets/front/images/bodyfront.png') }}" class="mapper" name=bodyfront width="210" height="522" border=1 useMap=#frontmap style="display:inline;">
...
<IMG src="{{ asset('assets/front/images/bodyback.png') }}" class="mapper" name=bodyback width="210" height="522" border=1 useMap=#backmap style="display:inline;">
...
<IMG src="{{ asset('assets/front/images/bodyside.png') }}" class="mapper" name=bodyside width="210" height="522" border=1 useMap=#sidemap style="display:inline;">
